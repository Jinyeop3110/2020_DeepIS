...
class _NonLocalBlockND(nn.Module):
    def __init__(self, in_channels, inter_channels=None, dimension=3, mode='concat',
                 sub_sample_factor=4, bn_layer=True):
        super(_NonLocalBlockND, self).__init__()

        assert dimension in [1, 2, 3]
        assert mode in ['embedded_gaussian', 'gaussian', 'dot_product', 'concat', 'concat_proper', 'concat_proper_down']
        ...
        if mode in ['embedded_gaussian', 'dot_product', 'concat', 'concat_proper', 'concat_proper_down']:
