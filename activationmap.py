...
class CNNLayerVisualization():
    ...
    def visualise_layer_with_hooks(self):
        ...
        for i in range(1, 31):
            ...
            if i % 5 == 0:
                data = {}
                data['processed_image'] = torch.squeeze(self.processed_image).numpy()
                scipy.io.savemat(
                    "/home/jysong/PyCharmProjects_JY/181007_3DcellSegmentation_regressionVer_TBdistinguish/activationtest" + "/activationtest%04d.mat" % (
                        i), data)
...
if __name__ == '__main__':
    ...
    model = CNNTrainer(arg, net, torch_device, recon_loss=None, val_loss=None, logger=logger)
